          ...
          <div className="footer-left-panel">
            ...
            <div className="footer-links-grid">
              <div className="footer-link-column">
                <h5>Services</h5>
                <ul>
                  <li><a href="#labs">IntelEdge Labs</a></li>
                  <li><a href="#advisory">IntelEdge Advisory</a></li>
                  <li><a href="#training">Training and Programs</a></li>
                </ul>
              </div>
              <div className="footer-link-column">
                <h5>Labs Products</h5>
                <ul>
                  <li><a href="#labs">Prospect IQ</a></li>
                  <li><a href="#labs">DocMind</a></li>
                  <li><a href="#labs">TalentLens</a></li>
                  <li><a href="#labs">VoiceOps</a></li>
                </ul>
              </div>
              <div className="footer-link-column">
                <h5>Company</h5>
